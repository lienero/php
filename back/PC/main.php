...
<html class = "no-js"; lang="en" dir="ltr">
  <head>
    ...
    <script src="/back/js/vendor/modernizr-custom.js"></script>
    <!--우리가 만든 디자인과 효과를 모든 브라우저와 똑같이 구동시키기 위한 장치 -->
    <script src="/back/js/vendor/jquery-ui-1.10.3.custom.min.js"></script>
    <script src="/back/js/mainproject.js"></script><!--js연결-->
