...
<body>
<?php
include $_SERVER['DOCUMENT_ROOT']."/register/db/db.php";
...
?>
	<sapn><button type="button" onclick="location.href='/register/mypage/mypage.php'" >마이페이지</button></sapn>
...
?>	
    <nav id="topMenu">
        <ul>
            ...
            <li><a class="menuLink" href="mypage.php">레시피</a></li>
            <li><a class="menuLink" href="comment_write_read.php">게시판</a></li>
        </ul>
    </nav>
    </div>
		...
		<form action="comment_write_ok.php" method="post" enctype="multipart/form-data">
			...
			?>	
				...
				<div class="bt_cm">
					...
					<button type="button"onclick="location.href='/register/index.php'">로그인 페이지로</button>
				</div>
			<?php
			}
			?>
    ...
    <div id="comment_info_area">
    	...
    	<table class="list-table">
            ...
            <tr>
				...
				<td width="100"><img src="http://localhost/register/img/poster/<?php echo $comment_info['image']; ?>" width="100"/></td>
