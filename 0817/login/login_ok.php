...
<?php	
	...
	$sql = mq("select * from member where mem_id='".$_POST['userid']."'");
	...
	if(password_verify($password, $hash_pw)) 
	{
		...
		$_SESSION['userpw'] = $member["mem_pw"];
		
		echo "<script>alert('로그인되었습니다.'); location.href='/recipe_site/mypage/mypage.php';</script>";
